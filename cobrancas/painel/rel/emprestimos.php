...
$ativos = 0;
$inativos = 0;
$query = $pdo->query("SELECT * from emprestimos where data >= '$dataInicial' and data <= '$dataFinal' order by id desc");
...
$parcelas_pagas = @count($res2);
      ...
      <tr>
<td style="width:30%;" class="<?php echo $classe_debito ?>"><?php echo $nome_cliente ?> <?php echo $classe_finalizado ?></td>
				...
				<tbody>
					<tr>
						...
						<td style="font-size: 10px; width:180px; text-align: right;"></td>
							...
							<td style="font-size: 10px; width:180px; text-align: right;">TOTAL EMPRÉSTIMOS: <?php echo $linhas ?></td>
