				...
				<nav class="navbar navbar-inverse">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo @$clientes ?>">					<a href="index.php?pagina=clientes"><i class="fa fa-user"></i> Clientes</a>	
							</li>

							<li class="treeview <?php echo @$usuarios ?>">					<a href="index.php?pagina=usuarios"><i class="fa fa-users"></i> Usuários</a>	
							</li>
							...
							<li class="treeview <?php echo @$menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$feriados ?>"><a href="index.php?pagina=feriados"><i class="fa fa-angle-right"></i> Feriados</a></li>
							...
							<li class="treeview <?php echo @$menu_financeiro ?>">
								...
								<ul class="treeview-menu">
									<li class="<?php echo @$pagar ?>"><a href="index.php?pagina=pagar"><i class="fa fa-angle-right"></i> Despesas / Saídas</a></li>

									<li class="<?php echo @$receber ?>"><a href="index.php?pagina=receber"><i class="fa fa-angle-right"></i> Entradas / Recebimentos</a></li>

									<li class="<?php echo @$receber_vencidas ?>"><a href="index.php?pagina=receber_vencidas"><i class="fa fa-angle-right"></i> Receber Vencidas</a></li>
									...
									<li class="<?php echo @$relatorios_financeiro ?>"><a href="" data-toggle="modal" data-target="#modalRelFin"><i class="fa fa-angle-right"></i> Relatórios Financeiro</a></li>
										...
										<li class="<?php echo @$relatorios_lucros ?>"><a href="index.php?pagina=lucro" data-toggle="modal"><i class="fa fa-angle-right"></i>Lucro Empréstimos</a></li>
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-2">					
								...
								<input type="number" class="form-control" id="dias_aviso" name="dias_aviso" placeholder="Alertar o Vencimento" value="<?php echo @$dias_aviso ?>">							
						</div>
					...
					<div class="col-md-4">						
						...
						<div class="col-md-3">						
								<label>Verificar Pagamento</label>
								<select class="form-control" name="verificar_pagamentos">
									<option value="Sim" <?php if(@$verificar_pagamentos == 'Sim'){?> selected <?php } ?> >Sim</option>
									<option value="Não" <?php if(@$verificar_pagamentos == 'Não'){?> selected <?php } ?> >Não</option>
								</select>							
						</div>
