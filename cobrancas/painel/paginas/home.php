...
for($i=0; $i<$linhas; $i++){
	...
	$total_clientes_debitos += @count($res2);
}
	...
	<div class="col_3">
		...
		<div class="col-md-3 widget widget1">
			<div class="r3_counter_box">
				...
				<div class="stats">
					<h5><strong>R$ <?php echo @$total_emprestimos_vencidosF ?></strong></h5>
		...
		<div class="col-md-3 widget widget1">
			<div class="r3_counter_box">
				...
				<div class="stats">
					<h5><strong><?php if($total_receber_mes < 1000){ ?>R$ <?php } ?><?php echo @$total_receber_mesF ?></strong></h5>
		...
		<div class="col-md-4 stat">
			<div class="content-top-1">
				<div class="col-md-6 top-content">
					<h5>Recebidos Mês</h5>
					<label style="font-size:16px"><?php echo $total_receber_mes_emprestimosF ?> / <?php echo $total_recebido ?></label>
				</div>
