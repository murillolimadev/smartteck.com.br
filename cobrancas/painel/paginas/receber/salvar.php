...
if($id == ""){
$query = $pdo->prepare("INSERT INTO $tabela SET descricao = :descricao, valor = :valor, data = curDate(), data_venc = '$data_venc', usuario_lanc = '$id_usuario', referencia = 'Conta', pago = 'Não', obs = :obs, cliente = '$cliente' ");
