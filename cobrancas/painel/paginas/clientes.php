			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">							
								...
								<input type="text" class="form-control" id="juros" name="juros" placeholder="Júros se Houver" value="<?php echo $juros_sistema ?>">							
						</div>


						<div class="col-md-4">							
								<label>Multa R$</label>
								<input type="text" class="form-control" id="multa" name="multa" placeholder="Multa se Houver" value="<?php echo $multa_sistema ?>">							
						</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-3">							
								<label>Valor</label>
								<input type="text" class="form-control" id="valor_cob" name="valor" placeholder="Valor" required>							
						</div>
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">							
								...
								<input type="text" class="form-control" id="valor_final" name="valor_final" placeholder="Total Pago" required>							
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-4">							
								<label>Valor</label>
								<input type="text" class="form-control" id="valor_final_emprestimo" name="valor_final_emprestimo" placeholder="Valor">							
						</div>				
