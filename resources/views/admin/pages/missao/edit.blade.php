        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default color-palette-box">
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ route('admin.pages.missao.update', ['id' => $missao->id]) }}" method="post"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" class="form-control" required cols="30" rows="10">{{ $missao->content }}</textarea>
                                        </div>
                                    </div>
